...
## 필수 원칙
1. 모든 작업은 `codex.md`와 합동작업 로그에 동시 기록.
   - v0: `합동작업.md`
   - v1.0: `합동작업 v1.md` (+ 스펙은 `docs/sdd/v1.0/*`)
...
### 2026-02-14 기록 51 (v1.0 공동 개발 로그 분리)
- 작업:
  - v1.0부터 SDD 기반으로 개발하기 위한 문서 스캐폴딩 생성
  - Claude 공유용으로 `합동작업 v1.md`를 신설하고 v1.0 로그를 분리
- 변경 파일:
  - `docs/sdd/v1.0/*`
  - `합동작업 v1.md`
  - `codex.md`, `합동작업.md`
- 결과:
  - v1.0 개발은 `docs/sdd/v1.0/*` 스펙을 SSOT로 두고 진행
  - v1.0 작업 기록은 `합동작업 v1.md`에 누적
